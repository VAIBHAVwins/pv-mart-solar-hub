  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Bihar Tariff Management</h1>
          <p className="text-gray-600 text-lg">
            Manage Bihar electricity tariffs, slabs, and provider configurations.
          </p>
        </div>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="provider-select-tariff">Provider</Label>
                      <Select value={selectedProvider} onValueChange={setSelectedProvider}>
                        <SelectTrigger>
                          <SelectValue placeholder="Select provider" />
                        </SelectTrigger>
          ...
          <TabsContent value="fppca">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage monthly FPPCA rates for providers
                </CardDescription>
              </CardHeader>
              <CardContent>
...
export default BiharTariffManager;
